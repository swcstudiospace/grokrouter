...
grep -q 'labelWithString: "GROK BOT 0.30.0 · 0.44.0"' "$PROJECT_ROOT/installer/GrokBotRouterInstaller.swift"
grep -q 'private let supportedGrokVersions = \["0.30.0", "0.44.0"\]' "$PROJECT_ROOT/installer/GrokBotRouterInstaller.swift"
