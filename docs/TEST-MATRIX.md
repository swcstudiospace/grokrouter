...
| Grok Bot 0.44.0 host adapter | Multi-manifest selection, dual mock anchor, install/doctor/restore on a 0.44.0-shaped fixture; manifest hash and byte count taken from a live probe | Not yet installed on a live 0.44.0 host; identity-variable scope near `mainSessionOptions` awaiting probe | Automated pass; live pending |
